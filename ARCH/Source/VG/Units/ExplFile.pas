...
{ TExplorerDrivesNode incapsulates My computer shell folder }
  ...
  protected
    ...
    { Called when node is about to expand and creates a TExplorerDriveNode nodes }
  public
...
{ TExplorerDirNode is a basic class for directory and file }
  ...
  protected
    ...
    procedure InternalExpand; override;
    { Called when node is about to expand and creates a list of children }
...
implementation
uses ShellAPI, ShlObj, Graphics, vgVCLUtl;

{$R ExplFile.res}

var
  DrivesCount: Integer = 0;
  LargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} = nil;
  SmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} = nil;
  StateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} = nil;
...
begin
  ...
  begin
    ...
    LargeImages := {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}.Create(nil);
    ...
    SmallImages := {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}.Create(nil);
    ...
    StateImages := {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}.Create(nil);
...
function TExplorerDrivesNode.GetLargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := LargeImages;
end;

function TExplorerDrivesNode.GetSmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := SmallImages;
end;

function TExplorerDrivesNode.GetStateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := StateImages;
end;

procedure TExplorerDrivesNode.InternalExpand;
var
  DriveNum: Integer;
  DriveChar: Char;
...
function TExplorerFileNode.GetLargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := LargeImages;
end;
...
function TExplorerFileNode.GetSmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := SmallImages;
end;

function TExplorerFileNode.GetStateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := StateImages;
end;
...
procedure TExplorerDirNode.InternalExpand;
const
