...
TYPE
  ...
  TWriteProc = procedure(VAR DTA; NBytes:Integer; VAR Bytes_Put : Integer) of object;
  ...
  TReadProc = procedure(VAR DTA; NBytes:Integer; VAR Bytes_Got : Integer) of object;
