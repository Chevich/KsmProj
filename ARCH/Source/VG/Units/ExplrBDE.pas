...
const
  DefaultConfigMode = {$IFNDEF _D3_}cmPersistent{$ELSE}[cfmPersistent]{$ENDIF};
...
{ TExplorerSessionNode }
  ...
  published
    ...
    property ConfigMode: TConfigMode read FConfigMode write SetConfigMode default DefaultConfigMode;
  end;
