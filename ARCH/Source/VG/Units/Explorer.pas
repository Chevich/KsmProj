...
interface
uses Messages, Windows, Classes, vgTools, Controls, Menus, Forms{$IFDEF _D4_}, ImgList, ActnList{$ENDIF};
...
{$ENDIF}
  ...
  TExplorerNodeState      = (nsChanged, nsChangedFolders, nsChangedNodes, nsChangedSeparators, nsChecked,
    nsEnabled, nsExpandLock, nsRadioItem, nsVisible, nsExpanded);
  TExplorerNodeStates     = set of TExplorerNodeState;
  TExplorerImageList      = (ilLarge, ilSmall, ilState);
  TExplorerImageLists     = set of TExplorerImageList;
...
{ TExplorerNodes }
  ...
  protected
    ...
    function GetLargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; dynamic;
    function GetSmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; dynamic;
    function GetStateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; dynamic;
...
{ TExplorerInterfaceNode }
  ...
  private
    ...
    FImageLists: array [0..2] of {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
    ...
    procedure SetImageList(Index: Integer; Value: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF});
  protected
    ...
    function GetLargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; override;
    function GetSmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; override;
    function GetStateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; override;
    procedure Notification(AComponent: TComponent; Operation: TOperation); override;
  public
    function AcceptsNodes(ExplorerNodes: TExplorerNodes): Boolean; override;
    procedure Assign(Source: TPersistent); override;
  ...
  published
    ...
    property ImageIndex;
    property Index;
    property LargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} index 0 read FImageLists[0] write SetImageList;
    property OverlayIndex;
    property PopupMenu;
    property RadioItem;
    property SelectedIndex;
    property SmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} index 1 read FImageLists[1] write SetImageList;
    property StateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} index 2 read FImageLists[2] write SetImageList;
    property StateIndex;
    property SubItems;
    property Text;
    property Visible;
...
{ TExplorerFormNode }
  ...
  protected
    ...
    procedure Notification(AComponent: TComponent; Operation: TOperation); override;
  public
    function CreateForm(AOwner: TComponent; Assign: Boolean): TForm;
    function FormNeeded(AOwner: TComponent): TForm;
...
{ TExplorerSource }
  ...
  private
    FImageLists: array [0..5] of {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
    FImages: TExplorerImageLists;
    FLinks: TList;
    ...
    FOnDelete: TExplorerNodesListEvent;
    ...
    procedure SetImageList(Index: Integer; Value: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF});
    procedure SetImages(Value: TExplorerImageLists);
  protected
  ...
  public
    ...
    function GetLargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
    ...
    function GetSmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
    function GetStateIndex(ExplorerNodes: TExplorerNodes): Integer;
    function GetStateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
    property Disabled: Boolean read GetDisabled;
  published
    property ExplorerRoot: TExplorerNodes read FExplorerRoot write SetExplorerRoot;
    property Images: TExplorerImageLists read FImages write SetImages default [];
    property LargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} index 0 read FImageLists[0] write SetImageList;
    property SmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} index 1 read FImageLists[1] write SetImageList;
    property StateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF} index 2 read FImageLists[2] write SetImageList;
...
implementation
uses Consts, SysUtils, Graphics, ClipBrd, vgUtils, vgVCLUtl;
...
type
  ...
  private
    FImageLists: array[0..1] of {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
    FDestIndex, FSourceIndex: Integer;
  protected
    procedure Notification(AComponent: TComponent; Operation: TOperation); override;
  public
    constructor CreateNew(Source, Dest: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; ImageIndex: Integer);
    destructor Destroy; override;
  end;
...
{ TImageEntry }
constructor TImageEntry.CreateNew(Source, Dest: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; ImageIndex: Integer);
begin
...
function FindImageIndex(Source, Dest: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; Index: Integer): Integer;
var
  I: Integer;
  Entry: TImageEntry;
begin
...
function RegisterImage(Source, Dest: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}; Index: Integer): Integer;
var
  Bitmap: TBitmap;
begin
...
procedure ClearImages(ImageList: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF});
var
  I: Integer;
  Entry: TImageEntry;
begin
...
begin
  if (nsExpanded in FState) then Exit;
  BeginExpand;
  try
    InternalExpand;
...
function TExplorerNodes.GetLargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := nil;
end;
...
function TExplorerNodes.GetSmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := nil;
end;

function TExplorerNodes.GetStateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := nil;
end;
...
function TExplorerInterfaceNode.GetLargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := FImageLists[0];
end;

function TExplorerInterfaceNode.GetSmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  Result := FImageLists[1];
end;

function TExplorerInterfaceNode.GetStateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
...
procedure TExplorerInterfaceNode.SetImageList(Index: Integer; Value: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF});
begin
...
procedure TExplorerStringsNode.InternalChangedChildren;
begin
  if FSorted then AnsiSortChildren(Self);
end;
...
procedure TExplorerStringsNode.SetSorted(Value: Boolean);
begin
...
function TExplorerFormNode.CreateForm(AOwner: TComponent; Assign: Boolean): TForm;
var
...
function TExplorerFormNode.FormNeeded(AOwner: TComponent): TForm;
begin
  if not Assigned(FForm) then CreateForm(AOwner, True);
  Result := FForm;
end;

procedure TExplorerFormNode.SetForm(Value: TForm);
begin
  if (FForm <> Value) then
  begin
    FForm := Value;
...
begin
  ...
  try
    ...
    begin
      Nodes := List[I];
      if Nodes.CanCopy then Nodes.DoCopy;
    end;
  finally
    Close;
  end;
...
begin
  ...
  try
    Clear;
    FState := csCut;
    { Cutting may cause destroying }
    for I := List.Count - 1 downto 0 do
    begin
      Nodes := List[I];
      if Nodes.CanCut then Nodes.DoCopy;
    end
  finally
    Close;
  end;
...
begin
  ...
  begin
    if Assigned(FOnDblClick) then FOnDblClick(Self, ExplorerNodes);
...
begin
  if Assigned(FOnDelete) then
    ...
    for I := List.Count - 1 downto 0 do List[I].DoDelete;
end;
...
var
  Images, SelfImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  if Large then
  begin
...
function TExplorerSource.GetLargeImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
...
function TExplorerSource.GetSmallImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
...
function TExplorerSource.GetStateImages: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF};
begin
  ...
  begin
    ...
    try
      ...
      begin
        ...
        if Assigned(FImageLists[3]) then
        begin
...
procedure TExplorerSource.SetImageList(Index: Integer; Value: {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF});
begin
  if (FImageLists[Index] <> Value) then
  begin
    FImageLists[Index] := Value;
...
procedure TExplorerSource.SetImages(Value: TExplorerImageLists);
var
  I: TExplorerImageList;
begin
  for I := Low(TExplorerImageList) to High(TExplorerImageList) do
  begin
    ...
    begin
      Include(FImages, I);
      FImageLists[3 + Integer(I)] := {$IFDEF _D4_} TCustomImageList {$ELSE} TImageList {$ENDIF}.Create(Self);
      ExplorerEvent(nil, eeLargeImagesChange - Integer(I), []);
    end;
  end;
end;
