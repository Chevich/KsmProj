-- N+9 часть марлезонского балета от Леши ;-)

insert into STA.PersonForm2
    (IDB,IDW,TypeContract,DateOn,DateOff,ReasonOff)
select 18,ID,1,(if DateOn<'01.01.2003' then '01.01.2003' else DateOn endif),
...
call sta.personform2generate(24);
select recdata from sta.personform2rep order by recid;
output to 'd:\\WORKS\\PersonUchet\\Packs\\00024.txt' format ascii;